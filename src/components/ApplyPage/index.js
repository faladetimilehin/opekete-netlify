...
const ApplyPage = () => {
                    ...
                    <div className="col col-lg-12 col-12">
                        <div className="wpo-wpo-blog-content clearfix">
                            <div className="post">
                                ...
                                <p>Maximum of 200,000 per annum for each student.
                                    (Tuition to be paid directly to the school) </p>
                                ...
                                <ul>
                                    <li>•	Female</li>
                                    <li>•	In senior secondary school or About to enter University to study Nursing or Teaching. </li>
                                    <li>•	Attending a public secondary school or federal government owned tertiary institution.
                                        Unable to afford tuition - Write an essay on the extenuating circumstance which you believe qualifies you for the scholarship.
                                    </li>
                                </ul>
                                <h2>Academic Qualifications</h2>
                                <ul>
                                    <li>•	Minimum of 4 Distinctions and 4 Merits or an average of 75% in the previous class</li>
                                    <li>
                                    •	To qualify, participants who are about move to SS1 must show that they have had a minimum of 4 distinctions and 4 merits in their Junior WAEC with an average of 75%.
                                    </li>
                                </ul>
    ...
    <a href="/scholarship" style={{color:'#f0628a'}} >click here to apply now  </a> and upload your supporting documents. Application closes on the 15th of August (to allow people to get their results</p>
                                ...
                                <p>The Announcement of Awardees shall be made on or around the 15th of September</p>
                            </div>
